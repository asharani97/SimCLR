...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='results/128_0.5_1024_1000_true_model.pth',
    ...
    #print("c",len(train_data.classes))
    #for param in model.f.parameters():
       # param.requires_grad = False
    learn_rate=0.3*(batch_size/256)
    optimizer = optim.Adam(model.parameters(), lr=1e-3, weight_decay=1e-4)#,momentum=0.9)
    ...
    for epoch in range(1, epochs + 1):
        ...
        if best_acc<test_acc_1:
            best_acc=test_acc_1
        if best_acc_5<test_acc_5:
            best_acc_5=test_acc_5
